...
$storeInfo =array();
$storeInfo = $store->fetchStoreInfo('antique'); // Assuming 'coffee' is the store identifier
...
<div class="nav">
    <ul>
        <li class="heading" style="float:left">
            <a href="GA.php" style="font-size: 30px"><?php echo $storeInfo[1]; ?></a>
        </li>

        <li style="float:right">
            <a href="GGC.php">Coffee</a>
        </li>
...
<form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" style="text-align: center">
    <input type="submit" value="Complete Order" name="submit" required  style="background-color: #403010;
...
if(isset($_POST['submit'])){
    ...
    if(!empty($cart)){
        ...
        echo "order sent.";
        echo "<br>";
        echo "<a href='GA.php'>Shop for more antiques!</a>";
    }
    else{
