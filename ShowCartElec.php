...
<form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" style="text-align: center">
    <input type="submit" value="Complete Order" name="submit" required  style="background-color: #000080;
...
if(isset($_POST['submit'])){
    ...
    if(!empty($cart)){
        ...
        echo "order sent.";
        echo "<br>";
        echo "<a href='GEB.php'>Shop for more electronics!</a>";
    }
    else{
        echo "Cart is empty. Shop for some electronics!";
    }
